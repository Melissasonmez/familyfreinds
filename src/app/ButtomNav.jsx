...
export default function BottomNav() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 border-t bg-white shadow-sm">
      <div className="mx-auto flex max-w-screen-sm items-center justify-between px-6 py-2 text-gray-600">
        {/* Home */}
