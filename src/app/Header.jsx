export default function Header({ sticky = false }) {
  return (
    <header
      className={`${sticky ? "sticky top-0 z-20" : ""} border-b/0 bg-white`}
    >
      <div className="mx-auto flex max-w-screen-sm items-center justify-between px-4 py-4">
        ...
        <button
          ...
          className="relative flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm transition active:scale-90"
        >
